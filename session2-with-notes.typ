...
Students dealt with these questions according to their levels of competence.

+ Some managed to begin tackling proper counting of possibilities while filling the board.
+ Some still hadn't quite grasped why the number of orderings of n distinct
  entities in sequence is $n!$.
+ Some just need to do more "leg work" to explore the problems and were shying away
  from it.
+ Some actively sought patterns in the combinations of various solution-preserving
  transformations discussed.
+ Some had attempted Euler's problem in earnest and were prompted to consider
  formalizing their solution strategies.
+ The class wasn't mature enough to face abstractions like groups (in my opinion).
